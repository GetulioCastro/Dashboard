---
description: Revisa implementação contra plano + PRD + arquitetura. Gera relatório REVIEW-{T-XX} com findings R-XX categorizados. Argumento opcional: T-XX e/ou path do diff/PR.
---
...
Use a cascata em `.opencode/skills/reviewer-leanwork/references/stack-detection.md` da skill `reviewer-leanwork`:
