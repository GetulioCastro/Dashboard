---
description: Especifica a interface a partir de protótipo existente ou gera um novo. Produz SPEC-UI com telas (UI-XX) mapeadas contra o PRD. Argumento opcional: caminho do PRD e/ou do protótipo.
---
