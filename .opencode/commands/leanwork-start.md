---
description: Inicia o pipeline SDD da Leanwork (architect → PRD → protótipo → planner → review) para uma nova demanda. Argumento opcional: descrição curta da demanda.
---
