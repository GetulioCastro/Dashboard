...
A seção **Comandos** do `AGENTS.md` é a única que não tem fonte nos artefatos do pipeline SDD — precisa vir de inspeção do repositório.
...
Extrair as chaves existentes e mapear para as categorias do AGENTS.md. Nomes comuns, mas **sempre conferir o que existe de fato**:
