# Template — AGENTS.md da raiz do projeto
...
> Com as skills e comandos Leanwork portados em `.opencode/`, `/leanwork-execute` faz os passos 1 a 8 e `/leanwork-review T-XX` faz a revisão. Sem os comandos, seguir os passos manualmente — eles não dependem de ferramenta.
