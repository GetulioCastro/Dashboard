# Template — AGENTS.md de módulo

Template do arquivo de contexto que fica dentro de uma pasta de módulo. Alvo: **20-50 linhas**. Se ficar abaixo de ~15 linhas úteis, o módulo provavelmente não justifica um AGENTS.md próprio — avisar o usuário.
...
[**Apenas** o que diverge do padrão declarado no AGENTS.md da raiz. Se este módulo
...
A seção mais valiosa do AGENTS.md de módulo, especialmente em LMA ou modular monolith. É onde o agente descobre que não pode simplesmente importar a entidade do módulo vizinho.
...
## Quando NÃO criar AGENTS.md de módulo
...
- **Projeto com módulo único** — o AGENTS.md da raiz já cobre tudo.
