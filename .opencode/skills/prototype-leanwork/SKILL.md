...
Ver `.opencode/skills/prototype-leanwork/references/ingestion-guide.md` para o procedimento detalhado por formato.
...
Ver `.opencode/skills/prototype-leanwork/references/generation-guide.md` para arquétipos, condução e delegação.
...
Usar `.opencode/skills/prototype-leanwork/references/spec-ui-template.md`. Salvar como `docs/prototype/SPEC-UI-XXX-nome-kebab.md`, usando **o mesmo número do PRD** correspondente.
...
Ver `.opencode/skills/prototype-leanwork/references/screen-states.md` para o catálogo de estados — a seção mais valiosa do documento, porque é onde a maioria dos bugs de interface nasce.

## Convenções de ID

`UI-XX` segue as regras gerais do pipeline (ver `.opencode/templates/id-conventions.md`):
...
- `.opencode/skills/prototype-leanwork/references/spec-ui-template.md` — template do documento SPEC-UI
- `.opencode/skills/prototype-leanwork/references/ingestion-guide.md` — extração por formato (HTML, imagens, Figma MCP, Lovable/v0)
- `.opencode/skills/prototype-leanwork/references/generation-guide.md` — arquétipos de interface, condução da entrevista e delegação do craft visual
- `.opencode/skills/prototype-leanwork/references/screen-states.md` — catálogo de estados de tela e quando cada um é obrigatório
- `.opencode/stacks/dotnet/pipeline-example.md` — exemplo end-to-end (calibrado em .NET) da mesma demanda nas cinco fases; consultar para ver como um `CA-XX` do PRD vira estado `UI-XX.sufixo` e como o plano e o review consomem esse estado
