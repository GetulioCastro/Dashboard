...
├── src/
├── tests/
├── AGENTS.md                           # instrução de leitura do pipeline
└── README.md
```
...
Recomenda-se que o projeto tenha um `AGENTS.md` na raiz indicando ao agente como navegar o pipeline.
...
Padrão de nomeação de testes: `CA_XX_descricao_do_cenario` (ver `.opencode/templates/id-conventions.md`).
